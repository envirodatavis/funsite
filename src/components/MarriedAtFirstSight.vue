<template>
  <v-container>
    <v-row justify="center" no-gutters>
      <v-col align="center">
        <h4>
          Predictions as of episode three:
        </h4>
      </v-col>
    </v-row>
    <v-row justify="center" no-gutters>
    ...
    <v-row justify="center" no-gutters>
      <v-col align="center">
        <v-card-text style="padding:0; color: grey; max-width:300px;">
          * Paul's results came in far after voting had ceased. This was perhaps
...
export default {
  ...
  computed: {
    xGroups: function() {
      return d3.map(this.surveyResults, (e) => e.couple).keys();
    },
    yGroups: function() {
      return d3.map(this.surveyResults, (e) => e.viewer).keys();
    },
    scales: function() {
      const x = d3
        .scaleBand()
  ...
  methods: {
    instantiateViz: function() {
      ...
      svg
        ...
        .style("stroke", "white")
        .style("fill", (e) => (e.prediction === "Married" ? "red" : "grey"))
        .style("opacity", 0.8)
        .attr("rx", 10)
        .attr("ry", 10)
        .attr(
      ...
      svg
        ...
        .html((e) => (e.prediction === "Married" ? married : ""));
      ...
      svg
        ...
        .html((e) => (e.prediction === "Married" ? "" : brokenHeartD));
